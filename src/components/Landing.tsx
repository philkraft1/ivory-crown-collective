        ...
        <section className="relative z-10 flex h-full min-h-0 flex-col">
          ...
          <div className="relative shrink-0 bg-gradient-to-t from-void via-void/90 to-transparent px-5 pb-[max(1.25rem,env(safe-area-inset-bottom))] pt-4 text-center sm:px-8 sm:pb-7 sm:pt-2">
            ...
            <a
              ...
              className="animate-rise-delay-3 group relative mt-4 inline-flex items-center justify-center overflow-hidden px-7 py-3 font-[family-name:var(--font-cinzel)] text-[0.7rem] font-semibold tracking-[0.28em] text-ink uppercase sm:mt-5 sm:px-8 sm:py-3.5 sm:text-xs"
            >
              <span
                aria-hidden="true"
